...
data = np.loadtxt(os.path.join(os.path.dirname(os.getcwd()), 'results/2301_4', 'quydaodieukhien.txt'))
...
data_2 = np.loadtxt(os.path.join(os.path.dirname(os.getcwd()), 'results/2301_4', 'e.txt'))
...
# Đọc dữ liệu từ tệp văn bản
data_three = np.loadtxt(os.path.join(os.path.dirname(os.getcwd()), 'results/2301_4','controll.txt'))
