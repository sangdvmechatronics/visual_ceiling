...
dictionary = {
    ...
    24: {'ID': 23, 'r_o_i': [[25.16-0.76-0.76+0.1], [-13.78], [0], [1]],'phi': 0},

    25: {'ID': 24, 'r_o_i': [[26.96-0.76-0.76+0.1], [-13.78], [0], [1]],'phi': 0},
    26: {'ID': 25, 'r_o_i': [[28.76-0.76-0.76+0.1], [-13.78], [0], [1]],'phi': 0},
    27: {'ID': 26, 'r_o_i': [[30.56-0.76-0.76+0.1], [-13.78], [0], [1]],'phi': 0},

    28: {'ID': 27, 'r_o_i': [[32.36-0.76-0.76+0.1], [-13.78], [0], [1]],'phi': 0},
    29: {'ID': 28, 'r_o_i': [[34.16-0.76-0.76+0.1], [-13.78], [0], [1]],'phi': 0},
    30: {'ID': 29, 'r_o_i': [[35.96-0.76-0.76+0.1], [-13.78], [0], [1]],'phi': 0},

    31: {'ID': 30, 'r_o_i': [[37.76-0.76-0.76+0.1], [-13.78], [0], [1]],'phi': 0},
    32: {'ID': 31, 'r_o_i': [[38.76-0.76-0.76+0.1], [-13.78], [0], [1]],'phi': 0},
